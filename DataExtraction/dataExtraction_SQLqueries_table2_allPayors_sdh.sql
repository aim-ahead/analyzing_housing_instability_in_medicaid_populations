...
into s36.dbo.f1_all_payors_housingInstability_encounter_rownum414458
...
select * 
into S36.dbo.f1_all_payors_housingInstability_demographics_rownum122212
from FellowsSample.S36.PATIENT_DIMENSION
where patient_num in (select distinct(patient_num) from S36.dbo.f1_all_payors_housingInstability_encounter_rownum414458);
